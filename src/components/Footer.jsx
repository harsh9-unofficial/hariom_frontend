...
export default function Footer() {
  return (
    <footer className="bg-[#558AFF] text-white px-3 md:px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 lg:gap-0 py-4 md:py-7">

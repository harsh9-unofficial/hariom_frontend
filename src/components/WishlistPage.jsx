            ...
            return (
              ...
              >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-8 mt-2">
                      <button
                        ...
                        className="bg-[#558AFF] text-white text-xs px-4 py-2 rounded"
                      >
                        Add to Cart
                      </button>
                      <Trash2
                ...
                <div className="hidden md:flex col-span-2 justify-center md:justify-start">
                  <button
                    onClick={() => addToCart(item.productId)}
                    className="bg-[#558AFF] text-white px-6 py-2 sm:px-10 sm:py-3 rounded text-sm cursor-pointer transition"
                  >
                    Add To Cart
                  </button>
                </div>

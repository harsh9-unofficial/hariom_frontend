            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`input border border-gray-300 text-gray-500 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#558AFF] ${
        ...
        <div className="border border-gray-300 p-3 rounded-lg h-fit bg-white">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className={`w-full bg-[#558AFF] text-white py-2 rounded-md mt-3 text-lg transition-all ${
